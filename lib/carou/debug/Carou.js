/* carou-fixed.js
   Fixed version of the user's carousel builder.
   - Fixes missing nextSlide/showSlide/totalItems references inside BuildDelfauts.
   - Avoids throwing when there are no items (size null warnings).
   - Exposes small instance hooks so insert/delete/timer can coordinate.
*/

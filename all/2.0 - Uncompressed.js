...
// Downloader (Comptibility)
// Moved to MANANGER in v1.2
...
// MDMark
// This part of this script is imported from https://cdn.jsdelivr.net/npm/marked/marked.min.js . It's under MIT License.
  /**
...
// End of https://cdn.jsdelivr.net/npm/marked/marked.min.js file. All others content are created for MAT-Services API.

document.addEventListener("DOMContentLoaded", () => {
  const markdownBlocks = document.querySelectorAll('md');
